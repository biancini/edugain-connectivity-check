...
function getCurrentUrl($params, $excludeParam=array()) {
    ...
    if (!in_array("f_spEntityID", $excludeParam) && array_key_exists("f_spEntityID", $params)) {
        $url .= "&f_spEntityID=" . $params['f_spEntityID'];
    }
    if (!in_array("f_check_time", $excludeParam) && array_key_exists("f_check_time", $params)) {
        $url .= "&f_check_time=" . $params['f_check_time'];
    }
    if (!in_array("f_http_status_code", $excludeParam) && array_key_exists("f_http_status_code", $params)) {
        $url .= "&f_http_status_code=" . $params['f_http_status_code'];
    }
    if (!in_array("f_check_result", $excludeParam) && array_key_exists("f_check_result", $params)) {
        $url .= "&f_check_result=" . $params['f_check_result'];
    }
    return $url;
}
